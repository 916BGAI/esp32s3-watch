...
void ui_mainScreen_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_mainScreen, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Button1, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
